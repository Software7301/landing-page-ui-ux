  ...
  return (
    ...
    >
      <motion.div
        ...
        initial="rest"
        whileHover="hover"
        className="bg-[#0F0F15] border border-[rgba(124,58,237,0.12)] hover:border-[rgba(124,58,237,0.25)] hover:bg-[#14141F] rounded-lg p-8 cursor-pointer relative overflow-hidden transition-all duration-300"
      >
        <motion.div
